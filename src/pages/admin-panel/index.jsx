    ...
    const ServiceManagement = () => {
        return (
            <React.Fragment>
                <br />
                <div>
                    <p className="font-sans text-2xl font-semibold italic">System Management</p>
                    <div className="border-b-2 border-gray-300 mt-6"></div>
                    <br />
                    <div className="w-full max-w-sm bg-white rounded-lg border border-gray-200 shadow-lg dark:bg-gray-800 dark:border-gray-700">
                ...
                <div>
                    <p className="font-sans text-2xl font-semibold italic">Reports Management</p>
                    <div className="border-b-2 border-gray-300 mt-6"></div>
                    <br />

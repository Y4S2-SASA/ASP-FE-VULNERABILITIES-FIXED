                    ...
                    <div className="ml-10 flex flex-col md:flex-row space-x-20">
                        ...
                        <div className="hover:scale-110 transition duration-300 ease-in-out w-64 max-w-sm bg-white rounded-lg border border-gray-200 shadow-lg dark:bg-gray-800 dark:border-gray-700">
                            <div className="flex flex-col items-center pb-10 mt-10">
                                ...
                                <div className="flex mt-4 space-x-3 md:mt-6">
                                    <a href="/order-report" className="inline-flex items-center py-2 px-4 text-sm font-medium text-center text-white bg-red-800 rounded-lg hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-600 dark:bg-red-600 dark:hover:bg-red-600 dark:focus:ring-red-600">Go</a>
                                </div>
                            </div>
                        </div>
                        <div className="hover:scale-110 transition duration-300 ease-in-out w-64 max-w-sm bg-white rounded-lg border border-gray-200 shadow-lg dark:bg-gray-800 dark:border-gray-700">

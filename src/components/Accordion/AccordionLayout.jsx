...
const AccordionLayout = ({ title, children, index, activeIndex, setActiveIndex }) => {
    ...
    return (
        <>
        {
            ...
            :
            <>
            <div onClick={() => handleSetIndex(index)} className='flex items-center justify-between bg-gray-50 w-full p-5 font-medium text-left text-gray-500 border border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-800'>
            <div className='flex'>
                <div className='font-semibold text-left text-gray-500 rounded-t-xl '>{title}</div>
            </div>
            <div className="flex items-center justify-center">
